...
"""
Training script with online generation of batch of data. Evaluation is done on OOD data.
...
from ..args import TrainingConfig, build_eval_launch_config
from ..eval import run_evaluation
from .args import build_train_config

...
accelerate launch -m apps.large_scale.rebuttal.training.finetune --save_dir "llama" --run_name "sft_Lam8B_facts=5-epochs=2-batch=4-gradAcc=32-LR=2e-5-loraR=0-loraA=0-weight"

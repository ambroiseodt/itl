...
accelerate launch -m apps.large_scale.training.finetune_parallelized --save_dir "debug" --run_name "sft_Smol135M_facts=8-epochs=2-batch=8-gradAcc=2-LR=1e-3-loraR=0-loraA=0-weight"
